...
const initialState = {
    ...
    "transcriber": new LocalizedStrings({
		"en": {
			"accept": "Accept",
			"alltasks": "All Tasks",
			"alltasksEmptyMessage": "There aren't any tasks available.",
			"assigned": "Assigned",
			"available": "Available",
			"bible": "Bible",
			...
			"inProgressEmptyMessage": "You don’t have any tasks inprogress to you.",
			...
			"review": "Review",
			"reviewed": "Reviewed",
			"reviewedEmptyMessage": "You don’t have any tasks reviewed to you.",
			"storybook": "Storybook",
			"submit": "Submit",
			"synced": "Synced",
			"syncedEmptyMessage": "You don’t have any tasks synced to you.",
			"test": "Test",
			"transcribe": "Transcribe",
			"transcribed": "Transcribed",
			"transcribedEmptyMessage": "You don’t have any tasks transcribed to you.",
			"unassign": "Unassign",
			"upload": "Upload",
